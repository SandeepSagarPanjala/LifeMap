...
/**
 * Classic activity insights (v1) — totals, schedule timing, calendar, amounts.
 */
export function ActivityInsightDetailV1Content({
  activity,
  moments,
}: {
  activity: ActivityRow;
  ...
  const theme = INTENT_THEME[snapshot.intent];
