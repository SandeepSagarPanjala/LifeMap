...
function serializeSegment(
  ...
  return {
    ...
    fromPlaceLabel: segment.fromPlaceLabel ?? null,
    fromPlaceId: segment.fromPlaceId ?? null,
    fromPlaceKind: segment.fromPlaceKind ?? null,
    toPlaceLabel: segment.toPlaceLabel ?? null,
    toPlaceId: segment.toPlaceId ?? null,
    toPlaceKind: segment.toPlaceKind ?? null,
    rawPathPointCount: rawPointCount,
    pathPointCount: pathSerialized.length,
    path: pathSerialized,
  };
