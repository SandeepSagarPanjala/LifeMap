...
const m0027 = `CREATE TABLE IF NOT EXISTS \`location_day_summaries\` (
	\`date_key\` text PRIMARY KEY NOT NULL,
...
const m0040 = `CREATE TABLE IF NOT EXISTS \`health_sleep_sessions\` (
	\`id\` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	\`uuid\` text NOT NULL,
	\`start_at\` integer NOT NULL,
	\`end_at\` integer NOT NULL,
...
const m0044 = `DROP INDEX IF EXISTS \`location_points_timestamp_idx\`;
--> statement-breakpoint
