...
export const STAY_AREA_STROKE = `rgba(255, 149, 0, ${
  STAY_AREA_OPACITY + 0.12
})`;
...
export const STAY_AREA_STROKE_EMPHASIS = `rgba(255, 149, 0, ${
  STAY_AREA_EMPHASIS_OPACITY + 0.15
})`;
